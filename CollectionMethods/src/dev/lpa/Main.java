...
/*
        placing 52 in an arrayList list does not fill the arrayList with 52 null values like it would an array
        here the fill method won't work because the cards list has no values in it
        therefore, it has fewer elements that the items being filled
 */
...
//        list must be sorted before binary search can be executed on it
...
//        checking for duplicates in your collection
