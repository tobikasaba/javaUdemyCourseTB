...
public class Meal {
    ...
    private class Burger extends Item {
        ...
        /*
        removing public from this constructor makes is package private. Hence, it cant be accessed.
        Unless burger is not  subclassed, you cant access it  If you don't put any access modifier, the default is private,
         */
//
...
//            return super.price;
        ...
        public void addToppings(String... selectedToppings) {
            for (var selectedTopping : selectedToppings) {
                try {
        ...
        /*
                interfaces, enums and record are by default static in inner classes therefor there is no need to specify static in them
                 */
        private enum Extra {
